  ...
  return (
    <>
      <Button
        ...
        className={cn(
          "group max-lg:fixed  border-border border-white hover:bg-transparent bg-color-picker rounded-xl  border-2  shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-primary/20",
